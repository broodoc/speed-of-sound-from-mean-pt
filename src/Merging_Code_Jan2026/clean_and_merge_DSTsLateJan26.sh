...
#        double sw = 250; # 200, 54 GeV
#        double sw = 31; # 27 GeV refMult
#        double sw = 185; # 27 GeV refMult2
...
if [[ -f "${dir}/../Glauber_fit_refMult2/bestChi2RootFile" ]]; then
    echo "✅ bestChi2RootFile found in ../"
    fin="${dir}/../Glauber_fit_refMult2/bestChi2RootFile"
    echo "$fin"
elif [[ -f "${dir}/../../Glauber_fit_refMult2/bestChi2RootFile" ]]; then
    echo "✅ bestChi2RootFile found in ../../"
    fin="${dir}/../../Glauber_fit_refMult2/bestChi2RootFile"
    echo "$fin"
else
...
TH1D *hRefMult = (TH1D*)ftemp->Get("dEta1p0__pTlow0p20_hRefMult2Corr");
...
if (h && hRefMult) {
    ...
    TFile *fout = new TFile(ftemp_path, "UPDATE");
