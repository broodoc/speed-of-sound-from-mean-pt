...
//            fit->SetParameters(0.08, 0.07, 7.9, 1000);
            ...
            fit->SetParLimits(1, 0.1, 0.2);  // C
            fit->SetParLimits(2, 4.5, 8.);  // n
            fit->SetParLimits(3, 0.0, 1e7);   // dN/dy
//            fit->SetParLimits(1, 0.16, 0.2);
//            fit->SetParLimits(2, 5, 12);
//            fit->SetParLimits(1, 0., 0.1);
        ...
        case Function::Tsallis:
            ...
            break;
        case Function::Hagedorn:
            fit->SetParameters(0.139, 0.2, 8, 1000);
            fit->FixParameter(0, 0.13957); //pion mass for inclusive spectra
//            fit->SetParLimits(0, 0.01, 0.3);
//            fit->SetParLimits(1, 0.1, 10);
...
double Parameterization::GetErrorMeanpT(const TH1 *h, TF1 *fit, bool usecut,
    ...
    double uncertainty{0}; double fit_cut{0.2};
...
//    TF1 *Right_knee_fit = new TF1(fitName,Parameterization::RightKneeFunction,low_cut, high_cut,2); // 2 parameters (cs2 = par1, normalization = par0)
    ...
    PowerLaw_fit->SetParameter(1, 1.0);     // normalization
...
//    std::vector<Function> fitFunctions = {Function::LevyTsallis, Function::Hagedorn, Function::FokkerPlanck, Function::Tsallis, Function::ExpDecay};
//    std::vector<Function> fitFunctions = {Function::LevyTsallis, Function::Hagedorn,};
//    std::vector<Function> fitFunctions = {Function::LevyTsallis, Function::TBW,};
//    std::vector<Function> fitFunctions = {Function::TBW,};
//    std::vector<Function> fitFunctions = {Function::ExpDecay,};
//    std::vector<Function> fitFunctions = {Function::LevyTsallis,};
//    std::vector<Function> fitFunctions = {Function::Hagedorn,};
//    std::vector<Function> fitFunctions = {Function::LevyTsallis, Function::Hagedorn, Function::TBW, Function::ExpDecay};
...
//    lOut->Add(params.GetBlackCurve());
//    lOut->Add(params.GetRedCurve());
//    lOut->Add(params.GetBlueCurve());
//    lOut->Add(params.GetOrangeCurve());
...
//            int ref_bin{9}; // <- you can try varying reference class here 5%->12 (OLD: 5%->17; 10%->23)
