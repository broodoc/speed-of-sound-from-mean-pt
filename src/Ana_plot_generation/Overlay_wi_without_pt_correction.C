void Overlay_wi_without_pt_correction() {
    // File paths
    TString path_excl = "/Users/calebbroodo/sos_analysis/prepped_files/200COL_Run11/200COL_Run11_rC_w_corrections_acc_from_data_wi_Pip_pT_correction_pTlow0p20_Glauber_Exclusive/graphs_output_2025-Jul-08_09-35AM.root";
    TString path_incl = "/Users/calebbroodo/sos_analysis/prepped_files/200COL_Run11/200COL_Run11_rC_w_corrections_acc_from_data_wi_Pip_pT_correction_pTlow0p20_Glauber_Inclusive/graphs_output_2025-Jul-04_10-23AM.root";

    // Open ROOT files
    TFile* file_excl = TFile::Open(path_excl);
    TFile* file_incl = TFile::Open(path_incl);
    ...
    leg->AddEntry(g_excl, "Exclusive", "pl");
    leg->AddEntry(g_incl, "Inclusive", "pl");
    leg->Draw();
