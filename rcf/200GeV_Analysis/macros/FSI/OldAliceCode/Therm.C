...
void Therm(){
  ...
  bool BoostPairsIntoPRF=kFALSE;
  massPOI = masspiC;
  PIDPOI = 211;// 211 for pi+-
  qCutOff = 0.1;

  int Nfiles=100;// 1000 for b2, 500 b3-b5, 1500 b7-b8, 3000 b9
  int bValue=2;

  double RValue=8;
  if(bValue==2) RValue=8;
  if(bValue==3) RValue=8;
  if(bValue==5) RValue=7;
  if(bValue==7) RValue=6;
  if(bValue==8) RValue=5;
  if(bValue==9) RValue=5;
  ...
  //
  TH3D *r3num=new TH3D("r3num","",50,0,.1, 50,0,.1, 50,0,.1);
  TH3D *r3den1=new TH3D("r3den1","",50,0,.1, 50,0,.1, 50,0,.1);
  TH3D *r3den2=new TH3D("r3den2","",50,0,.1, 50,0,.1, 50,0,.1);
  TH3D *r3den3=new TH3D("r3den3","",50,0,.1, 50,0,.1, 50,0,.1);
  TH3D *r3numSq=new TH3D("r3numSq","",50,0,.1, 50,0,.1, 50,0,.1);
  TH3D *r3den1Sq=new TH3D("r3den1Sq","",50,0,.1, 50,0,.1, 50,0,.1);
  TH3D *r3den2Sq=new TH3D("r3den2Sq","",50,0,.1, 50,0,.1, 50,0,.1);
  TH3D *r3den3Sq=new TH3D("r3den3Sq","",50,0,.1, 50,0,.1, 50,0,.1);
  TH3D *r3numEn=new TH3D("r3numEn","",50,0,.1, 50,0,.1, 50,0,.1);
  TH3D *r3den1En=new TH3D("r3den1En","",50,0,.1, 50,0,.1, 50,0,.1);
  TH3D *r3den2En=new TH3D("r3den2En","",50,0,.1, 50,0,.1, 50,0,.1);
  TH3D *r3den3En=new TH3D("r3den3En","",50,0,.1, 50,0,.1, 50,0,.1);
  TH3D *r3numME=new TH3D("r3numME","",50,0,.1, 50,0,.1, 50,0,.1);
  TH3D *r3den1ME=new TH3D("r3den1ME","",50,0,.1, 50,0,.1, 50,0,.1);
  TH3D *r3den2ME=new TH3D("r3den2ME","",50,0,.1, 50,0,.1, 50,0,.1);
  TH3D *r3den3ME=new TH3D("r3den3ME","",50,0,.1, 50,0,.1, 50,0,.1);
  //
  //
  TH2D *K2_ss = new TH2D("K2_ss","",20,0,1, 50,0,0.1);
  TH2D *PlaneWF_ss = new TH2D("PlaneWF_ss","",20,0,1, 50,0,0.1);
  TH2D *K2_os = new TH2D("K2_os","",20,0,1, 50,0,0.1);
  TH2D *PlaneWF_os = new TH2D("PlaneWF_os","",20,0,1, 50,0,0.1);
  //
  TH1D *PlaneWF3ss = new TH1D("PlaneWF3ss","",50,0,0.1);
  TH1D *PlaneWF3os = new TH1D("PlaneWF3os","",50,0,0.1);
  TH1D *K3ss = new TH1D("K3ss","",50,0,0.1);
  K3ss->GetXaxis()->SetTitle("Q3 (GeV/c)");
  K3ss->GetYaxis()->SetTitle("K_{3}");
  TH1D *K3os = new TH1D("K3os","",50,0,0.1);
  K3os->GetXaxis()->SetTitle("Q3 (GeV/c)");
  K3os->GetYaxis()->SetTitle("K_{3}");
  TH3D *K3ss_3D = new TH3D("K3ss_3D","", 50,0,0.1, 50,0,0.1, 50,0,0.1);
  K3ss_3D->GetXaxis()->SetTitle("q12");
  K3ss_3D->GetYaxis()->SetTitle("q23");
  K3ss_3D->GetZaxis()->SetTitle("q31");
  TH3D *PlaneWF3ss_3D = new TH3D("PlaneWF3ss_3D","", 50,0,0.1, 50,0,0.1, 50,0,0.1);
  TH3D *K3os_3D = new TH3D("K3os_3D","", 50,0,0.1, 50,0,0.1, 50,0,0.1);
  K3os_3D->GetXaxis()->SetTitle("q12");
  K3os_3D->GetYaxis()->SetTitle("q23");
  K3os_3D->GetZaxis()->SetTitle("q31");
  TH3D *PlaneWF3os_3D = new TH3D("PlaneWF3os_3D","", 50,0,0.1, 50,0,0.1, 50,0,0.1);
    ...
    *fname += FileN+1;
	...
	if(Gaussian){// Gaussian randomization
	  ...
	  while(goodchoice==kFALSE){
	    x = 3*RValue*RandomNumber->Rndm();// 3 sigma
	  ...
	  goodchoice=kFALSE;
	  while(goodchoice==kFALSE){
	    y = 3*RValue*RandomNumber->Rndm();// 3 sigma
	    float height = RandomNumber->Rndm();
	  ...
	  goodchoice=kFALSE;
	  while(goodchoice==kFALSE){
	    z = 3*RValue*RandomNumber->Rndm();// 3 sigma
	    float height = RandomNumber->Rndm();
	  ...
	  goodchoice=kFALSE;
	  while(goodchoice==kFALSE){
	    t = 3*RValue*RandomNumber->Rndm();// 3 sigma
	    float height = RandomNumber->Rndm();
	...
	if(t < 1e6) Primary[0][Npions]=kTRUE;// 1e6
	...
	for(int index1=0; index1<Nparticles[EN]; index1++){// current or past event pion loop
	  ...
	  for(int index2=start; index2<Npions; index2++){// current event pion loop (EN=0)
	    ...
	    double r1 = sqrt(pow(X[EN][index1][1],2) + pow(X[EN][index1][2],2) + pow(X[EN][index1][3],2));
	    DenLambda1->Fill(qinv12);
	    if(r1<RstarMax) NumLambda1->Fill(qinv12, r1*FmToGeV);
	    ...
	    //if(kt < 0.4 && kt > 0.39 && rstar12_CMS < 10.) cout<<rstar12_CMS<<"  "<<rstar12_PRF<<endl;
	    ...
	    if(EN==0 && !LambdaDirect && qinv12 < 0.2 && rstar12_PRF < RstarMax){
		...
		DenLambda3_os->Fill(qinv12, qinv23, qinv31);
	      ...
	      if(!Primary[EN2][index3]) continue;
	      if(!Primary[EN][index1] || !Primary[0][index2]) continue;
		...
		X1_PRF[0]=X[EN][index1][1]; X1_PRF[1]=X[EN][index1][2]; X1_PRF[2]=X[EN][index1][3];
		X2_PRF[0]=X[0][index2][1]; X2_PRF[1]=X[0][index2][2]; X2_PRF[2]=X[0][index2][3];
		X3_PRF[0]=X[EN2][index3][1]; X3_PRF[1]=X[EN2][index3][2]; X3_PRF[2]=X[EN2][index3][3];
	      }
	      //
	      if(BoostPairsIntoPRF){
		...
		//
	      ...
	      ThreePhase_1 = LX1*(LP1-LP2) + LX2*(LP2-LP3) + LX3*(LP3-LP1);
	      ThreePhase_2 = LX1*(LP1-LP2) + LX3*(LP2-LP3) + LX2*(LP3-LP1);
	      ThreePhase_3 = LX2*(LP1-LP2) + LX1*(LP2-LP3) + LX3*(LP3-LP1);
	      ThreePhase_4 = LX2*(LP1-LP2) + LX3*(LP2-LP3) + LX1*(LP3-LP1);
	      ThreePhase_5 = LX3*(LP1-LP2) + LX1*(LP2-LP3) + LX2*(LP3-LP1);
	      ThreePhase_6 = LX3*(LP1-LP2) + LX2*(LP2-LP3) + LX1*(LP3-LP1);

	      TwoPhase_12 = (LP1-LP2)*(LX1-LX2);
	      TwoPhase_23 = (LP2-LP3)*(LX2-LX3);
	      TwoPhase_31 = (LP3-LP1)*(LX3-LX1);
