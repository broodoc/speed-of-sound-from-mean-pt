...
cp -r /Users/calebbroodo/sos_analysis/tables_for_input/200GeV/Run11_v6_systematics/DCA1p9.txt input_table.txt
./getBusy.sh

#cp -r /Users/calebbroodo/sos_analysis/tables_for_input/200GeV/Run11_v6_systematics/DCA2p1.txt input_table.txt
#./getBusy.sh
#
